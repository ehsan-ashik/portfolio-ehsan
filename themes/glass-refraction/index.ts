...
export const glassRefractionTheme: ThemeConfig = {
    ...
    effects: {
        ...
        gradients: {
            enabled: true,
            backgrounds: [
                // Light mode: Soft, barely perceptible gradient
                'linear-gradient(135deg, hsl(0, 0%, 98%) 0%, hsl(210, 15%, 96%) 50%, hsl(0, 0%, 97%) 100%)',
                // Dark mode: Subtle dark gradient
                'linear-gradient(135deg, hsl(0, 0%, 7%) 0%, hsl(210, 15%, 10%) 50%, hsl(0, 0%, 8%) 100%)',
            ],
        },
    },
