    ...
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
    {
        variants: {
            variant: {
                ...
                default:
                    "backdrop-blur-xl bg-white/25 dark:bg-white/15 text-black dark:text-white border border-white/40 dark:border-white/30 shadow-[0_4px_20px_rgba(0,0,0,0.1)] hover:bg-white/40 dark:hover:bg-white/15 hover:border-white/40 dark:hover:border-white/40 hover:ring-1 hover:ring-black/10 dark:hover:ring-white/40 hover:shadow-[0_10px_40px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_8px_32px_rgba(255,255,255,0.1)] transition-all duration-300 font-semibold",

                // Glass destructive - strong visible hover
                destructive:
                    "backdrop-blur-xl bg-red-500/20 dark:bg-red-500/15 text-red-900 dark:text-red-100 border border-red-500/40 dark:border-red-500/30 shadow-[0_4px_16px_rgba(239,68,68,0.15)] hover:bg-red-500/40 dark:hover:bg-red-500/25 hover:border-red-500/40 dark:hover:border-red-500/50 hover:ring-1 hover:ring-red-900/20 dark:hover:ring-red-500/50 hover:shadow-[0_12px_48px_rgba(239,68,68,0.2)] dark:hover:shadow-[0_8px_32px_rgba(239,68,68,0.2)] hover:brightness-120",

                // Glass outline - VERY visible hover
                outline:
                    "backdrop-blur-lg bg-white/10 dark:bg-white/5 text-black dark:text-white border border-white/40 dark:border-white/30 shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:bg-white/40 dark:hover:bg-white/15 hover:border-white/40 dark:hover:border-white/40 hover:ring-1 hover:ring-black/10 dark:hover:ring-white/40 hover:shadow-[0_10px_40px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_8px_32px_rgba(255,255,255,0.1)]",

                // Glass secondary - "Thin/Clear" Glass
                // Low blur, barely visible opacity, subtle border = "Light" feel
                secondary:
                    "backdrop-blur-md bg-white/5 dark:bg-white/5 text-black/80 dark:text-white/90 border border-black/10 dark:border-white/10 shadow-none hover:bg-white/20 dark:hover:bg-white/15 hover:border-black/20 dark:hover:border-white/40 hover:ring-1 hover:ring-black/10 dark:hover:ring-white/40 hover:text-black dark:hover:text-white transition-all duration-300 hover:shadow-[0_10px_40px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_8px_32px_rgba(255,255,255,0.1)]",

                // Glass ghost - visible glow on hover
                ghost:
                    "text-black dark:text-white hover:backdrop-blur-lg hover:bg-white/20 dark:hover:bg-white/15 hover:border-white/40 dark:hover:border-white/40 hover:ring-1 hover:ring-black/10 dark:hover:ring-white/40 hover:shadow-[0_10px_40px_rgba(0,0,0,0.1)] dark:hover:shadow-[0_8px_32px_rgba(255,255,255,0.1)] transition-all duration-300",
